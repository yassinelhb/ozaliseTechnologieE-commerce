...
<body>
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="entre.php?id=1">Entre</a></li>
  ...
  <div class="tab-content">
     <div class="row">
       <div class="col-sm-12" style="padding:0 40px" >
         <form method="post">
         <div class="mail-bar">
           <a href="entre.php?id=<?php echo $_GET['id']; ?>" class="form-btn"><i class="fa fa-refresh"></i></a>
         ...
         <table class="table table-bordered table-striped" style="box-shadow:0 0 5px #eee">
          ...
          <tbody id="tab1">
            <?php if((isset($_POST['delete-radio']) ) && (isset($_POST['radio_id']) )){
                 ...
                 $bdd->exec("DELETE FROM entre WHERE id=$id");
                 ...
                 $dated=date("Y-m-d")." ".date("H:i:s");
                  ...
                  $donnees = $reponse->fetch();
                   $namem=$donnees['model'];
                    $namer=$donnees['referance'];
                     $namef=$donnees['famille'];

                 $bdd->exec("INSERT INTO modifie(id,famille,model,referance,Quantite,date_modifie)
                   values('$id','$namef','$namem','$namer','$qte','$dated')");
             ...
             <?php
               ...
               $reponse = $bdd->query("SELECT * from entre ");
               $nb= $reponse->rowCount();
               ...
               $nb2=$nb % $d;
                ...
                for ($i=2; $i < $nb1 ; $i++) { 
                     if ($id==$i) {
                      ...
                      $c=$i*$d-$d;  
                       $reponse = $bdd->query("SELECT * from entre LIMIT $d OFFSET $c");
                     }
               } 
        ...
        <div class="mail-bar" id="mail-bar">
          ...
          <?php 
           ...
           echo '<p class="txt-bottom">Résultats '.$c.' - '.$d1.' sur '.$nb3.' entries <p>'; ?>
             <div class="mail-left" >
              <ul class="nbr-page" >
                <li class="active"><a href="entre.php?id=1" class="form-btn nbr" >1</a></li>
                 <?php 
                      
                     for ($i=2; $i < $nb1 ; $i++) { 
                      echo'<li><a href="entre.php?id='.$i.'" class="form-btn nbr c2">'.$i.'</a></li>';
