       ...
       ?>  
        ...
        <div class="carousel-inner">
            <div class="item active">
                    ...
                    <ul class="thumbnails">
                     ...
                     if($prixsolde==0){
                      ...
                      $sale="Sale!";
							...
							echo '<img class="img-responsive zoom-img" src="produit/'.$donnees['img'].'" alt="">'.$pourcentage.'</a>';
							echo '<div class="product-bottom">';
							echo '<a href="single.php?id='.$donnees['id'].'">'.$donnees['marque'].'</a>';
              echo '<p class="star5">';
                    $star=$donnees['star']*0.07;
                   for ($i=0; $i < 5; $i++) { 
                      if($i<$star){
              ...
              echo '</p>';
							echo '<h4>'.$prix.' <span>'.$prixsolde.'</span></h4>';
							echo '</div>';
							echo '<p class="srchtop">New <span class="sale">'.$sale.'</span></p>
								<div class="srch">
