		...
		<div class="container">
            ...
            <?php 
                 $reponse = $DB_con->query("SELECT * FROM produit");
                   ...
                   $res=$DB_con->exec("INSERT INTO mailbox(user_id,message,refcom,objet,date_msg) values('$user','$txtmsg','$ref','$objet','$date')");
                   if ($res>0) {
                   	$msg='<span class="msgsucces">Votre msg a ete envoye...</span>';
                   }
   				}
            ?>
			<div class="col-md-8 about-center">
				...
				<div class="col-md-12 form-contact">
					...
					<div class="col-md-5">
						<label>Objet</label>
					    <input type="text" placeholder="Objet" name="objet" <?php if(isset($_POST['objet'])){ echo 'value="'.$_POST['objet'].'"';}?>>
					...
					<div class="col-md-7">
						<label>Message</label>
						<textarea name="txtmsg"  <?php if(isset($_POST['txtmsg'])){ echo 'value="'.$_POST['txtmsg'].'"';}?>></textarea>
					</div>
					<button type="submit" name="btn_envoie"> Envoyer</button><?php echo $msg; ?>
					</form>
