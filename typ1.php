			...
			<?php 
                  if(isset($_POST['btn_checked'])){
                     ...
                     $msg="";
                  	 ...
                  	 $re=$DB_con->exec("UPDATE users SET  user_prenom='$prenom',user_name='$nom',user_pass='$password',
                  	 	user_date='$date_n',user_sexe='$sexe' where user_email='$umail'");
				...
				<div class="col-md-12 form-insc">
					...
					<form method="post">
					    <div class="form-group col-sm-12">
							...
							else{echo 'value=homme';}?>><span> Mr.</span>
							 <input type="radio" name="check"
							  <?php if($donnes['user_sexe']=="femme"){ echo "checked";}
							else{echo 'value=femme';}?>><span> Mrs. </span>
						</div>
