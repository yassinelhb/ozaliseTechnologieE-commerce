...
function showHint(str) {
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "rescom.php?q=" + str, true);
        xmlhttp.send();
    }
}
</script>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                          ...
                          <div class="col-sm-12 second_block">
                                <div class="mail-bar">
                                   <a href="listcommande.php" class="form-btn"><i class="fa fa-refresh"></i></a>
                                     <div class="mail-left">
                              ...
                              <table class="table table-bordered table-striped">
                                ...
                                <tbody id="tab1">
                                    <?php 
                                      $rep = $DB_con->query("SELECT * FROM commande,produit,users
