...
if(isset($_POST['ajoute'])){
     ...
     $DB_con->exec("UPDATE formweb SET imgtop='$imgtop',imgleft='$imgleft',imgright='$imgright',imgcarousel1='$imgcarousel1',
     imgcarousel2='$imgcarousel2',imgbcar='$imgbcar',imgbot1='$imgbot1',imgbot2='$imgbot2',imgbot3='$imgbot3'");
