              ...
              $donnees = $reponse->fetch() ;
                      ...
                      if($prixsolde==0){
                         ...
                         $prixsolde="";
                             ...
                             $pourcentage='<span class="pcg">-'.$donnees['pourcentage'].'%</span>';
                               }
                      ...
                      echo'</ul>
                       ...
                       echo '</p>
                        <p class="prix_display">';
                           ...
                           $datefin=$donnees['datefinsolde'];
                         
                          echo $prix.$pourcentage.'<span>'.$prixsolde.'
                        ...
                        <button type="sumbit"><i class="fa fa-opencart" style="font-size:13px;padding-right:3px"></i> Ajouter au panier</button>
