  ...
  <div class="about" > 
    <div class="container">
     ...
     if(isset($_POST['btn-confirme'])){
          ...
          $DB_con->exec("UPDATE commande SET confirme='oui',date_com='$date_com',paiment='Virement bancaire' where user_id='$user' and confirme=''");
          $msg='<div class="col-sm-12 alertmsgs"><p><i class="fa fa-check"></i> Votre commande sur shoubikloubik a bien été enregistrée</p></div>';
          $btnr='<a href="commande.php" class="btn-panier">Voir l\'historique de vos commandes</a>';
        ...
        <?php echo $msg; ?>
         <div class="col-md-12 form-insc">
          ...
          <div class="col-sm-12 block-btn">
           <a href="panier.php" class="btn-panier">Autres moyens de paiment</a>
           <button type="sumbit" name="btn-confirme">Je confirme ma commande</button>
          </div>
          <?php
            echo $btnr;
          ?>  
