	...
	if(isset($_POST['rech'])){
	 ...
	 ?>
        ...
        <div class="col-md-4">
		 ...
		 if((isset($_POST['rech']))&&(($nb=="0")||($ref=="" && $nom=="" && $prenom=="" && $num=="")))
		 	{
		 		echo '<h2 class="erreur"> '.$msg.'</h2>';
		 	}
		 	?>
		 <div class="col-sm-12">
			<label for="ref">Par référence:</label>
			<input type="text" name="ref" id="ref" class="form-control" <?php if (isset($_POST['ref'])) {
				echo 'value="'.$ref.'"'; }?>>
		 </div>
		 <div class="col-sm-12">
			<label for="prenom">Par prénom:</label>
			<input type="text" name="prenom" id="prenom" class="form-control" <?php if (isset($_POST['prenom'])) {
				echo 'value="'.$prenom.'"'; }?>>
		 </div>
		 <div class="col-sm-12">
		 ...
		 <div class="col-sm-12">
			<label for="tel">Par N° de telephone:</label>
               ...
               echo'</div>	
				...
				<div class="col-sm-12">
				  ...
				  echo'<div class="btn-pro">
				       ...
				       <button  name="encours" value="encours" ><img src="loading_throbber.png"></button>
                       <button  name="true" value="true"><img src="check.png"></button>
                       <button name="false" value="false"><img src="deletered.png"></button>
                       </form>
					   </div>
					   </div>';
		}
